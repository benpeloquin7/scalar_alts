...
Data for domains is between subjects -- subjects only provide responses in the context of one domain at a time (providing 5 * 21 = 105 responses).

Data for individual words is within subjects -- subjects provide five ratings for each word (one judgement for each star rating 1-5 stars).
...
<center>
  <br>
  <img src="/Users/benpeloquin/Desktop/Projects/scalar_alts/admin/pre-registration/L0_design.png"
...
# Pragmatic Listener (L1) analysis 
...
Data for domains is between subjects -- subjects only provide responses in the context of one domain at a time (providing 1 * 21 = 21 responses).

Data for individual words is within subjects -- subjects provide one rating for each word.
...
<center>
  <br>
  <img src="/Users/benpeloquin/Desktop/Projects/scalar_alts/admin/pre-registration/L1_design.png"
  width="500px" height="200px" style='border:1px solid #000000'>
  <br>
